...
DATA_PATH = os.path.join(os.path.dirname(__file__), 'mesh_column')
...
def main():
    ...
    avg_layer_height = 9.0
    parameters = {
        'avg_layer_height': avg_layer_height,  # controls number of curves that will be generated
        'min_layer_height': avg_layer_height * 0.9,
        'max_layer_height': avg_layer_height * 1.2,
