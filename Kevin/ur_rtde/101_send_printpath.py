...
DATA_OUTPUT_FOLDER = os.path.join(os.path.dirname(__file__), 'leg_1', 'output')
#PRINT_FILE_NAME = 'support.json'
PRINT_FILE_NAME = 'slice.json'
...
if __name__ == "__main__":
    ...
    base_frame = Frame(Point(194, 412, -3.3), Vector(-1.000, 0, 0), Vector(0, -1.000, 0))

    retractSwitch = True if 2 in toggles else False
